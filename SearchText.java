...
public class SearchText {
	...
	/**
	 * @param Search Content and Search Key
	 */
	public static void main(String args[]) {
		...
		/**
		 * @param this block will spilt the search content by word and count it
		 */
		...
		/**
		 * @param this block will verify search content by char and count it
		 */
		if (count == 0) {
